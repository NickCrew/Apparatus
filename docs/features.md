...
<img src="assets/diagrams/diagram-11-interface-comparison.svg" alt="Interface comparison across web dashboard, CLI, terminal UI, and HTTP API capabilities." width="760" style="max-width: 100%; height: auto;" />
