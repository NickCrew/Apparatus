...
<img src="assets/diagrams/diagram-29-bottleneck-matrix.svg" alt="Metric-based bottleneck matrix mapping latency, CPU, memory, and error patterns to likely root causes." width="940" style="max-width: 100%; height: auto;" />
...
<img src="assets/diagrams/diagram-31-node-memory-management.svg" alt="Node.js memory management flow through young generation, minor GC, old generation, major GC, and event loop lag impact." width="940" style="max-width: 100%; height: auto;" />
...
<img src="assets/diagrams/diagram-30-optimization-impact.svg" alt="Optimization impact flow showing stacked throughput gains from middleware, heap, async, and connection tuning." width="940" style="max-width: 100%; height: auto;" />
